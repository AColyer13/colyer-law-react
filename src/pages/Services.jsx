    ...
    <main>
      ...
      <section className="cards-row section-mt-lg">
        <div className="card card-padded">
          ...
          <p><a href="https://www.americanbar.org/groups/real_property_trust_estate/resources/estate-planning/">Wills: Why You Should Have One and the Lawyer's Role in Its Preparation</a></p>
        </div>
        <div className="card card-padded">
